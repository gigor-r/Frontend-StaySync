    ...
    <div className="fade-in-up p-3 p-md-4 d-flex justify-content-center">
      <div style={{ maxWidth: 520, width: '100%' }}>
        ...
        <div
          ...
          style={{ borderRadius: 12, background: 'var(--ss-dark)', boxShadow: '0 4px 16px rgba(34,32,22,0.2)' }}
        >
          <div className="card-body p-4">
            ...
            <div className="d-flex gap-3 small mb-3" style={{ color: 'rgba(255,255,255,0.65)' }}>
              <span><i className="bi bi-calendar-event me-1" />{fechaEntrada ? new Date(fechaEntrada).toLocaleDateString('es-CO') : '—'}</span>
              <span><i className="bi bi-arrow-right mx-1" />{fechaSalida ? new Date(fechaSalida).toLocaleDateString('es-CO') : '—'}</span>
            ...
            <div className="d-flex flex-column gap-2">
              {METODOS.map(m => {
                ...
                return (
                  ...
                  >
                    <i
                      className={`bi ${m.icon} fs-5`}
                      style={{ color: seleccionado ? 'var(--ss-gold)' : 'var(--ss-dark)', width: 24, flexShrink: 0 }}
                    />
        ...
        <p className="text-center text-muted mt-3" style={{ fontSize: '0.75rem' }}>
          ...
          Entorno de desarrollo local — no se realizan cargos reales
        </p>
